<html>
  ...
  place-items: center;  /* Center the child elements both horizontally and vertically */
  ...
  .gallery {
    ...
    --s: 500px;
    /* the size */
    display: grid;  /* The grid area for the images */
...
<div class="gallery">
  ...
  <img src="./PICS/TourismTybes/Add a subheading1.png" onclick='window.location.href="./Soon Page/soonEnter.html"'></img>
</div>
